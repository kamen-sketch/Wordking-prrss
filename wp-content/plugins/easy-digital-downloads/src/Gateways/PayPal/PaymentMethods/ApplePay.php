<?php
/**
 * Apple Pay payment method descriptor.
 *
 * Rides on the merchant's advanced-card (ACDC) vetting and loads via the
 * `applepay` SDK component. Suppressed in dev and test environments, where the
 * publicly-resolvable domain verification Apple requires isn't meaningful.
 *
...
class ApplePay extends Method {
	...
	public static function get_label(): string {
		return __( 'Apple Pay', 'easy-digital-downloads' );
	}
	...
	public static function get_description(): string {
		return __( 'Accept Apple Pay on supported devices.', 'easy-digital-downloads' );
	}
	...
	public static function is_available(): bool {
		return ! edd_is_dev_environment() && ! edd_is_test_mode();
	}
}
