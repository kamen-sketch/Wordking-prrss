...
namespace Give\Vendors\LiquidWeb\LicensingApiClientWordPress\Http;

use Give\Vendors\LiquidWeb\LicensingApiClientWordPress\Exceptions\WordPressHttpClientException;
