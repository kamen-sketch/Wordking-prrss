...
use Give\Vendors\LiquidWeb\Harbor\Licensing\Error_Code;
...
final class License_Controller extends WP_REST_Controller {
		...
		register_rest_route(
			...
			[
				[
					...
					'args'                => [
						'key' => [
							'description'       => __( 'The license key to look up.', 'give' ),
							'type'              => 'string',
							'required'          => true,
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'      => [
					'description' => __( 'The unified license key.', 'give' ),
					'type'        => [ 'string', 'null' ],
					'context'     => [ 'view' ],
				],
				'products' => [
					'description' => __( 'The products associated with the license key.', 'give' ),
					'type'        => 'array',
					'context'     => [ 'view' ],
					'items'       => [
						'type'       => 'object',
						'properties' => [
							'product_slug'      => [
								'description' => __( 'The product identifier.', 'give' ),
								'type'        => 'string',
							],
							'tier'              => [
								'description' => __( 'The entitlement tier.', 'give' ),
								'type'        => 'string',
							],
							'status'            => [
								'description' => __( 'The entitlement status.', 'give' ),
								'type'        => 'string',
							],
							'expires'           => [
								'description' => __( 'The expiration date.', 'give' ),
								'type'        => 'string',
								'format'      => 'date-time',
							],
							'activations'       => [
								'description' => __( 'Activation seat data.', 'give' ),
								'type'        => 'object',
								'properties'  => [
									'site_limit'   => [
										'description' => __( 'Maximum activation seats (0 = unlimited).', 'give' ),
										'type'        => 'integer',
									],
									'active_count' => [
										'description' => __( 'Current active activations.', 'give' ),
										'type'        => 'integer',
									],
									'over_limit'   => [
										'description' => __( 'Whether the seat limit is exceeded.', 'give' ),
										'type'        => 'boolean',
									],
									'domains'      => [
										'description' => __( 'Activated domain names.', 'give' ),
										'type'        => 'array',
										'items'       => [ 'type' => 'string' ],
									],
								],
							...
							'capabilities'      => [
								'description' => __( 'Feature slugs granted by this entitlement.', 'give' ),
								'type'        => 'array',
								'items'       => [ 'type' => 'string' ],
							],
							'activated_here'    => [
								'description' => __( 'Whether the product is activated on this domain.', 'give' ),
								'type'        => [ 'boolean', 'null' ],
							],
							'validation_status' => [
								'description' => __( 'The validation status for this product.', 'give' ),
								'type'        => [ 'string', 'null' ],
							],
							'is_valid'          => [
								'description' => __( 'Whether the product has a valid license.', 'give' ),
								'type'        => 'boolean',
							],
						],
					],
				...
				'error'    => [
					'description' => __( 'An error encountered while fetching the license, or null if none.', 'give' ),
					'type'        => [ 'object', 'null' ],
					'context'     => [ 'view' ],
					'properties'  => [
						'code'    => [
							'description' => __( 'The error code.', 'give' ),
							'type'        => 'string',
						],
						'message' => [
							'description' => __( 'The error message.', 'give' ),
							'type'        => 'string',
						],
					],
				],
	...
	private function get_store_args(): array {
		return array_merge(
			[
				'key' => [
					'description'       => __( 'The license key to store.', 'give' ),
					'type'              => 'string',
					'required'          => true,
	...
	private function get_network_args(): array {
		return [
			'network' => [
				'description' => __( 'Whether to operate on the network-level key (multisite only).', 'give' ),
				'type'        => 'boolean',
				'default'     => false,
			],
		];
