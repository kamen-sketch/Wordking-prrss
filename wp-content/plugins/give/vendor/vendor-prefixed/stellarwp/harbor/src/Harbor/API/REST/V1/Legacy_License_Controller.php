...
use Give\Vendors\LiquidWeb\Harbor\Legacy\Legacy_License;
use Give\Vendors\LiquidWeb\Harbor\Legacy\License_Repository;
...
final class Legacy_License_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'        => [
					'description' => __( 'The license key.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'slug'       => [
					'description' => __( 'The plugin slug.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'name'       => [
					'description' => __( 'The plugin name.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product'    => [
					'description' => __( 'The product name.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'is_active'  => [
					'description' => __( 'Whether the license is currently active.', 'give' ),
					'type'        => 'boolean',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'page_url'   => [
					'description' => __( 'The license management page URL.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'expires_at' => [
					'description' => __( 'The license expiration date.', 'give' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
